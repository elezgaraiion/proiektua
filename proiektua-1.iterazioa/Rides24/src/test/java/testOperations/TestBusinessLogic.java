	...
	TestDataAccess dbManagerTest;
	   ...
	   public TestBusinessLogic()  {
		...
		public Driver createDriver(String email, String name,String password ,int balance,String number) {
			dbManagerTest.open();
			Driver driver=dbManagerTest.createDriver(email, name,password,balance,number);
			dbManagerTest.close();
			return driver;
		...
		public Driver addDriverWithRide(String email, String name, String from, String to,  Date date, int nPlaces, float price) {
			dbManagerTest.open();
			Driver driver=dbManagerTest.addDriverWithRide(email, name, from, to, date, nPlaces, price, to, nPlaces, to);
			dbManagerTest.close();
			return driver;
