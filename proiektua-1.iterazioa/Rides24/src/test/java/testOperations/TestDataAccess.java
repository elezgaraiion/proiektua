...
public class TestDataAccess {
	...
	public Driver createDriver(String email, String name,String password ,int balance,String number) {
		System.out.println(">> TestDataAccess: addDriver");
		Driver driver=null;
			db.getTransaction().begin();
			try {
			    driver=new Driver(name,email,password,balance,number);
				db.persist(driver);
				db.getTransaction().commit();
			}
			catch (Exception e){
	...
	public boolean existDriver(String email) {
		...
		public Driver addDriverWithRide(String email, String name, String from, String to,  Date date, int nPlaces, float price,String password ,int balance,String number) {
